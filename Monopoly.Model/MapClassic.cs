...
public class MapClassic
{
    private static District[] Districts =
    {
        new District(Color.SaddleBrown)
            .Append("Житная", new (60, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Нагатинская", new (60, 30, 33), new (50, 50), new (4, 8, 20, 60, 180, 320, 450)), 
        
        new District(Color.Gray)
            .Append("Варшавское шоссе", new (100, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Огарева", new (100, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Первая Парковая", new (120, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)), 
        
        new District(Color.Purple)
            .Append("Полянка", new (140, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Сретенка", new (140, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Ростовская наб.", new (160, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)), 
        
        new District(Color.Orange)
            .Append("Рязанский пр.", new (180, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Вавилова", new (180, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Рублевское", new (200, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)), 
        
        new District(Color.Red)
            .Append("Тверская", new (220, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Пушкинская", new (220, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Пл. Маяковского", new (240, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)),
        
        new District(Color.Yellow)
            .Append("Гурзинский Вал", new (260, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Новинский бул.", new (260, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Смоленская пл.", new (280, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)),
        
        new District(Color.Green)
            .Append("Щусева", new (300, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Гоголевский бул.", new (300, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Кутузовский пр.", new (320, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0)),
        
        new District(Color.Blue)
            .Append("Малая Бронная", new (350, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
            .Append("Арбат", new (400, 0, 0), new (0, 0), new (0, 0, 0, 0, 0, 0, 0))
    };
